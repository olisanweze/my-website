...
import { faHtml5, faCss3Alt, faJs, faMicrosoft, faReact, faWordpress } from '@fortawesome/free-brands-svg-icons';
...
function Skills() {
  return (
    <ul className="flex space-between tech">
      ...
      <li><FontAwesomeIcon icon={faWordpress} className="fa-brands" /> Wordpress</li>
